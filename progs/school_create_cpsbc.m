function school_create_cpsbc(year1, setNo)
...
if year1 >= 1992
   ...
   educ99V = var_load_cpsbc(cS.vEduc99, year1, setNo);
...
%       % except 1963
%       [educV, success] = var_load_cpsbc(cS.vEduc, year1, setNo);
%       if success ~= 1
...
var_save_cpsbc(schoolClV, cS.vSchoolGroup, year1, setNo);
...
var_save_cpsbc(schoolV, cS.vSchoolYears, year1, setNo);
